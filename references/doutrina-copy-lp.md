...
- Promessa de hype no imperativo ("FIQUE RICO", "GARANTIDO").
...
- **Teste/psicologia de PREÇO** (incl. A/B de preço) não está coberto pelas fontes-base. Se o caso envolver isso, pesquisar à parte.
- Benchmarks de conversão atuais por nicho não estão cobertos.
